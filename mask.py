...
baseCascadePath = "/opt/opencv3/data/haarcascades/"

# xml files describing our haar cascade classifiers
faceCascadeFilePath = baseCascadePath + "haarcascade_frontalface_default.xml"
noseCascadeFilePath = "/usr/share/opencv/haarcascades/haarcascade_mcs_nose.xml"
...
imgDecoration = cv2.imread('batman.png',-1)
