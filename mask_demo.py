...
if __name__ == "__main__":
    ...
    clear_button = [int(0.8 * h), int(0.9 * h), 0, int(0.1 * w)]

    # region of start-draw button
    start_draw_button = [int(0.8 * h), int(0.9 * h), int(0.13 * w), int(0.23 * w)]

    # region of return-draw button
    return_button = [int(0.8 * h), int(0.9 * h), int(0.26 * w), int(0.36 * w)]
